-- Insert simple sample data for testing
...
-- Insert employees
INSERT INTO employees (id, employee_code, first_name, last_name, email, status, created_at, updated_at) VALUES
(1,'EMP001','Nguyễn Văn','An','nguyen.van.an@company.com','Active',NOW(),NOW()),
(2,'EMP002','Trần Thị','Bình','tran.thi.binh@company.com','Active',NOW(),NOW());
